<div class="max-w-5xl mx-auto space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <a 
            ...
            class="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg text-xs font-semibold text-slate-700 bg-white border border-slate-200 hover:bg-slate-50 transition-colors shadow-xs"
        >
    ...
    <form wire:submit="save" class="space-y-6">
            ...
            <div class="max-w-xs">
                ...
                <div class="relative">
                    <input 
                        ...
                        id="report-date"
                        wire:model="date"
                        class="w-full pl-9 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-xs font-semibold text-slate-900 focus:bg-white focus:outline-none focus:ring-2 focus:ring-slate-900/10 focus:border-slate-900 transition-all"
                    />
        ...
        <div class="space-y-4">
            ...
            @error('projects')
                <div class="p-3 bg-red-50 border border-red-200 rounded-lg text-xs font-medium text-red-700">
                    {{ $message }}
                </div>
            @enderror
            ...
            @foreach($projects as $index => $project)
                <div 
                    ...
                    class="bg-white border border-slate-200 rounded-xl p-5 shadow-xs space-y-4 relative group"
                >
                    <!-- Entry Header -->
                    <div class="flex items-center justify-between border-b border-slate-100 pb-3">
                        ...
                        @if(count($projects) > 1)
                            <button 
                                ...
                                class="inline-flex items-center gap-1 px-2.5 py-1 rounded text-xs font-semibold text-red-600 bg-red-50 hover:bg-red-100 border border-red-200 transition-colors cursor-pointer"
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            class="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-xs font-medium text-slate-900 placeholder:text-slate-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-slate-900/10 focus:border-slate-900 transition-all"
                        />
        ...
        <div class="flex flex-col sm:flex-row items-center justify-between gap-4 pt-2">
            <button 
                ...
                class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg text-xs font-bold text-slate-700 bg-white border border-slate-300 hover:bg-slate-50 transition-colors shadow-xs cursor-pointer"
            >
            ...
            <div class="w-full sm:w-auto flex items-center gap-3">
                <a 
                    href="{{ route('employee.daily-task-report-list') }}"
                    class="w-1/2 sm:w-auto inline-flex items-center justify-center px-4 py-2.5 rounded-lg text-xs font-semibold text-slate-600 hover:text-slate-900 transition-colors text-center"
                >
                    Cancel
                </a>
                ...
                <button 
                    ...
                    class="w-1/2 sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-2.5 rounded-lg text-xs font-bold text-white bg-slate-900 hover:bg-slate-800 transition-colors shadow-xs cursor-pointer disabled:opacity-50"
                >
