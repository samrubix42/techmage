                    ...
                    <div class="p-6 space-y-6">
                        <div class="flex items-center gap-4 pb-4 border-b border-slate-100">
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    <span class="px-2.5 py-0.5 rounded-md text-xs font-medium {{ $selectedDepartment->is_active ? 'bg-emerald-50 text-emerald-700 border border-emerald-200' : 'bg-slate-100 text-slate-600 border border-slate-200' }}">
