...
>
    <div>
        ...
        <nav class="px-3 py-2 space-y-1">
            ...
            <a href="{{ route('employee.daily-task-report-list') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-xs font-semibold transition-colors {{ request()->routeIs('employee.daily-task-report*') ? 'bg-slate-900 text-white' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900' }}">
