    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (window.toast && toastData) {
                window.toast(toastData.message || '', {
...
@elseif (session()->has('attendance_status'))
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            if (window.toast) {
                window.toast(@json(session('attendance_status')), {
                    type: 'info',
                    position: 'top-right'
                });
            }
...
@elseif (session()->has('success'))
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            if (window.toast) {
                window.toast(@json(session('success')), {
                    type: 'success',
                    position: 'top-right'
                });
            }
...
@elseif (session()->has('error'))
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            if (window.toast) {
                window.toast(@json(session('error')), {
                    type: 'danger',
                    position: 'top-right'
                });
            }
